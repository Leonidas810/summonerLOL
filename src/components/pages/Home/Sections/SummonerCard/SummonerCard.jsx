         ...
         text-white shadow-2xl`} style={handleSectionMoveStyle(section)}>
            {
                (loadedAll) ?
                    ...
                    (!dataSummoner || !dataMastery || !summonerData.current?.topMasteryChamps) ?
                        <div>Error</div>
                        :
                        <div className="flex flex-col sm:flex-row items-center justify-between space-y-10 sm:space-y-0 sm:space-x-2 p-4 rounded-2xl" style={{
                        ...
                        >
                            ...
                            <div className="flex sm:flex-col items-center justify-center space-x-6 sm:space-x-0 sm:space-y-6 font-semibold text-sm ">
